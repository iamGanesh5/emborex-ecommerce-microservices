...
public class RestClintConfig {
    ...
    @Bean
    @LoadBalanced
    public RestClient.Builder restClientBuilderuser() {
        RestClient .Builder builder= RestClient.builder();
        if(observationRegistry !=null){
            builder.requestInterceptor(creatTracinginterceptor());
        }
        return builder;
    }

    private ClientHttpRequestInterceptor creatTracinginterceptor() {
